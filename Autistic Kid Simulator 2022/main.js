...
function createNewLife() {
  if (
    ...
    alert(
      "One or more fields have invalid inputs. (First and last name must not be blank or have spaces, and file name must not be blank.)"
    );
    return;
  }
...
country = WorldData.countries[Math.round(Mathc.randInt(0, 45))];
city =
